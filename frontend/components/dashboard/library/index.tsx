...
function Library() {
  ...
  return (
    <div className="mp_library relative w-full h-full">
      ...
      <div className="relative w-full mx-auto border rounded-lg mt-5 py-1 text-center">
        <Link
          href={"/produce"}
        ...
        >
          <IconMusic
            ...
            color={"#ffffff"}
          />
          <div className="text-pink-100 absolute text-2xl z-[4] w-[150px] top-[57%] left-1/2 translate-x-[-50%] translate-y-[-50%]">
            클릭하여 이동
          </div>
        </Link>
