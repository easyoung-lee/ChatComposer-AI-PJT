...
const Mp3Player = () => {
  ...
  return (
    <>
      ...
      <div className="mp_playlist_player absolute h-60 w-[160] shadow-[0_0_20px_rgb(0,0,0)] transition-[0.2s] duration-[ease-in-out] rounded-[10px] left-[50%] translate-x-[-50%] bottom-5 bg-black/20 hover:cursor-pointer">
        <img
